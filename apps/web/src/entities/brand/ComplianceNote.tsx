                ...
                <div className="mx-auto max-w-5xl md:grid md:grid-cols-[auto_1fr] md:gap-8">
                    ...
                    <div className="space-y-3 text-sm leading-relaxed">
                        <p className="text-muted-foreground">
                            ...
                            сплачує у своєму банку, а кошти надходять прямо на
                            ваш банківський рахунок.
                        </p>
                        <p className="text-muted-foreground">
                            Finly лише готує платіж, але не проводить його: ми
                            не зберігаємо платежі, не утримуємо комісій з
                            обороту і не маємо доступу до ваших коштів.
                        </p>
                    </div>
                </div>
            </div>
