...
export default function ResetAccountSlugConfirmDialog() {
    ...
    return (
        <UiConfirmDialog
            ...
            description="Адреса сторінки реквізитів зміниться на нову випадкову. Старі збережені посилання і надруковані QR ще певний час працюватимуть і вестимуть на нову адресу, потім перестануть."
