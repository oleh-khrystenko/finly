            ...
            <div>
                ...
                <FieldHint>
                    <p>
                        ...
                        необовʼязково. Головне правило: додавайте картинку, тільки
                        якщо вона щось пояснює. Гарна картинка допомагає зрозуміти
                        текст, порожня, просто займає місце, а невдала, навіть
                        шкодить.
                    </p>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            Проста наочна картинка, яка робить складне зрозумілішим.
                        </li>
                    </ul>
                    <p>
                        <strong>Що краще не додавати (лише займає місце):</strong>
                    </p>
                    <ul>
                        <li>
                            Гарні, але порожні картинки «для краси»: люди за
                            ноутбуком, рукостискання, монети, стрілочки вгору. Вони
                            нічого не пояснюють.
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            ...
                            (IBAN), податковий номер, прізвище клієнта, суми. Перед
                            зйомкою приберіть або замалюйте таке.
                        </li>
                        <li>
                            Розмиті, темні або дуже дрібні фото, на яких нічого не
                            видно.
                        </li>
                        <li>
                            Текст, зроблений картинкою (наприклад, скріншот абзацу).
                            Такий текст не читається пошуком і незрячими людьми:
                            пишіть його звичайним текстом у блоці.
                        </li>
                        <li>
            ...
            <div>
                ...
                <FieldHint>
                    <p>
                        ...
                        (яким пристрій озвучує сторінку) і пошукові системи, тому
                        він важливий. Наприклад: «Екран створення рахунку у
                        Finly».
                    </p>
                </FieldHint>
            </div>
