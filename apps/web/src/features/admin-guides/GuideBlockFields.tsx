        ...
        <div className="border-border bg-card rounded-xl border p-4 sm:p-5">
            ...
            <div className="mt-4 space-y-4">
                <div>
                    ...
                    <FieldHint>
                        <p>
                            ...
                            плутайте з назвою всієї статті, що вгорі).
                            Наприклад: «Які реквізити знадобляться». Можна
                            лишити порожнім, якщо цей блок іде без заголовка.
                        </p>
                    </FieldHint>
                </div>
                ...
                <div>
                    ...
                    <FieldHint>
                        <p>
                            Головний текст цього шматка статті. Пишіть
                            звичайними словами, так, як пояснили б знайомому за
                            столом.
                        </p>
                        <p>
                        ...
                        <ul>
                            ...
                            <li>
                                Щоб вставити посилання (клікабельне слово, що
                                веде на іншу сторінку), напишіть так:{' '}
                                <code>[слово](адреса)</code>. У квадратних
                                дужках те слово, яке побачить читач, у круглих,
                                адреса, куди воно веде.
                            </li>
                        </ul>
                        <p>Про посилання окремо, бо це важливо і корисно:</p>
                        <ul>
                            <li>
                                Щоб відправити читача на іншу вашу статтю,
                                адреса це <code>/guides/</code> плюс кінець
                                адреси тієї статті. Наприклад:{' '}
                                <code>
                                    [як виставити
                                    рахунок](/guides/yak-vystavyty-rakhunok-kliientu)
                                </code>
                                .
                            </li>
                            <li>
                                Щоб відправити на головну сторінку Finly,
