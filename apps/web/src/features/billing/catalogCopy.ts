...
export const PLAN_COPY: Record<string, PlanCopy> = {
    brand: {
        tagline: 'Власні посилання для бізнесу, реквізитів і рахунків',
        features: [
            'Власні посилання (slug) для бізнесу, реквізитів і рахунків',
    ...
    bookkeeper: {
        ...
        features: [
            ...
            'Режим бухгалтера: необмежено клієнтських бізнесів',
