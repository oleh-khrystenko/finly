...
export default function ResetInvoiceSlugConfirmDialog() {
    ...
    return (
        <UiConfirmDialog
            ...
            description="Адреса рахунку зміниться на нову за форматом нумерації реквізитів. Старі збережені посилання і надруковані QR ще певний час працюватимуть і вестимуть на нову адресу, потім перестануть."
