 ...
 *
 * Sprint 19: редагування і скидання slug — платна фіча (рівень не нижче brand,
 * `useCanEditSlug`). На Free кнопки редагування заміняє upsell; адреса,
 * копіювання і QR доступні всім. API дублює замок (`SLUG_EDIT_REQUIRES_PLAN`).
 *
