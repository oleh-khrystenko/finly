...
export interface UiSlugEditorProps {
     ...
     * Save кладе ім'я на холд і відкриває inline-апсел. Кнопка «Згенерувати
     * нове посилання» від цього прапора НЕ залежить — вона доступна всім рівням
     * (гігієна/ротація випадкової адреси, не брендова фіча).
     */
    isPaid: boolean;
