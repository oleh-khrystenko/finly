...
const ERRORS: Record<string, MessageDict> = {
    ...
    businesses: {
        ...
        // Sprint 20 — чіткіша копія апселу: що саме дає тариф (один код покриває
        // і ліміт клієнтів, і ліміт власних ТОВ/організацій, тож без точних чисел).
        business_limit_requires_plan:
            'Вільний ліміт отримувачів вичерпано. Тариф «Бухгалтер» дозволяє вести необмежену кількість бізнесів і клієнтів',
