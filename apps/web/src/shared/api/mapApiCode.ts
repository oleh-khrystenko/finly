...
const ERRORS: Record<string, MessageDict> = {
    auth: {
        ...
        // Sprint 31 — вікно відновлення минуло і прибирання вже почалось:
        // отримувачі з реквізитами і рахунками знесені, повертати нема чого.
        account_purge_in_progress:
            'Термін відновлення акаунту минув, дані вже видалено',
    },
    payments: {
        ...
        billing_cancel_pending:
            'Підписку скасовано. Відновіть підписку, щоб знову змінювати тариф.',
        // Sprint 43 — оборотне скасування і життєвий цикл картки.
        billing_not_canceled: 'Підписку не скасовано, відновлювати нічого.',
        billing_period_ended:
            'Оплачений період уже завершився. Оформіть підписку заново.',
        billing_card_required:
            'Щоб відновити підписку, додайте платіжну картку.',
        billing_not_disabled: 'Доступ активний, оплачувати зараз нічого.',
        billing_no_card_verification:
            "Прив'язку картки не знайдено. Спробуйте додати картку ще раз.",
        billing_past_due:
    ...
    businesses: {
        ...
        // Sprint 29 — незакрита або вкладена фігурна дужка у шаблоні (описка
        // адміна): такий уламок пішов би у призначення платежу літерально.
