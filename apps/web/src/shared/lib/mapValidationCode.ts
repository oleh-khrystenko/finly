...
const VALIDATION_MESSAGES: Record<string, string> = {
    ...
    // --- По батькові (middleNameSchema, Sprint 30) ---
    INVALID_MIDDLE_NAME_TOO_SHORT:
        'По батькові має містити щонайменше 2 символи',
    INVALID_MIDDLE_NAME_TOO_LONG:
        'По батькові не може бути довшим за 50 символів',
    INVALID_MIDDLE_NAME_FORMAT:
        'По батькові може містити лише літери, пробіли, дефіси та апострофи',

    // --- Значення підстановки на податковій сторінці (personalization*Zod) ---
    // Ті самі схеми валідують і збережений запис платника (форма у профілі),
    // тож коди мусять мати людські формулювання: без них RHF-форма показувала б
    // generic fallback на трьох різних причинах помилки.
    INVALID_PERSONALIZATION_REQUIRED: 'Заповніть це поле',
    INVALID_PERSONALIZATION_TOO_LONG: 'Значення задовге. Скоротіть його',
    INVALID_PERSONALIZATION_CHARSET:
        'Значення містить символи, які не підтримує платіжний QR-код. Використовуйте лише букви, цифри та звичайну пунктуацію',
