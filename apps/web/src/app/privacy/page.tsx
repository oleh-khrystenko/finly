...
export function generateMetadata(): Metadata {
    return fetchMetadata({
        ...
        meta: {
            ...
            description:
                'Як Finly обробляє персональні дані українських ФОП і бухгалтерів: що збираємо, що НЕ зберігаємо, права суб’єктів даних.',
        },
        ...
        <>
            ...
            <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-12">
                ...
                <Section title="2. Які дані ми обробляємо">
                    ...
                    <p>
                        <strong className="text-foreground">
                            Податкові дані у профілі:
                        </strong>{' '}
                        по батькові та РНОКПП. Поля опційні: вони потрібні лише
                        для сплати податків через Finly, щоб не вводити ці дані
                        вручну при кожному платежі. Ви можете очистити їх у
                        розділі «Профіль» у будь-який момент.
                    </p>
                    <p>
                        <strong className="text-foreground">
                            Список платників:
                        </strong>{' '}
                        ПІБ і РНОКПП людей, за яких ви платите податки (сценарій
                        бухгалтера, що обслуговує клієнтів). Ці дані вносите ви
                        самі, ми використовуємо їх виключно для підстановки у
                        призначення платежу на вашому екрані; нікому не
                        передаємо і для жодних інших цілей не обробляємо. Список
                        видно лише вам, кожен запис видаляється у розділі
                        «Профіль» → «Платники», а разом із видаленням акаунту
                        зникає весь список.
                    </p>
                    <p>
                        <strong className="text-foreground">
                    ...
                    <p>
                        ...
                        обробляються нашим платіжним партнером monobank; ми
                        зберігаємо лише токен картки для списань і маску картки,
                        не повні реквізити карток.
                    </p>
                </Section>
                ...
                <Section title="6. Cookies">
                    ...
                    <ul className="list-disc space-y-1.5 pl-6">
                        <li>
                            ...
                            сесії; діє для домену finly.com.ua і його
                            піддоменів, тому один вхід працює і в кабінеті, і на
                            сторінках оплати. Видаляється при виході з акаунту —
                            вихід на будь-якій зі сторінок завершує сесію всюди.
                        </li>
                    </ul>
                ...
                <Section title="7. Зберігання та видалення">
                    ...
                    <p>
                        ...
                        monobank), зберігаються протягом строків, встановлених
