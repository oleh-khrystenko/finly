            ...
            <main className="mx-auto max-w-3xl px-6 py-12">
                ...
                <Section title="1. Хто оператор персональних даних">
                    <p>
                        ...
                        бухгалтерів, що дозволяє генерувати платіжні
                        QR-коди й посилання за стандартом Національного банку
                        України. Сайт сервісу — finly.com.ua.
                    </p>
                    <p>
                ...
                <Section title="3. Що ми НЕ збираємо і НЕ обробляємо">
                    <p>
                        ...
                        до банківських акаунтів — ні вашого, ні ваших
                        клієнтів.
                    </p>
                    <p>
                ...
                <Section title="4. Підстави обробки">
                    <p>
                        Ми обробляємо персональні дані на таких підставах
                    ...
                    <ul className="list-disc space-y-1.5 pl-6">
                        <li>
                            ...
                            даних акаунту, реквізитів бізнесу, оплати
                            підписки;
                        </li>
                        <li>
                        ...
                        <li>
                            ваша згода — для опційних маркетингових
                            комунікацій (можна відкликати у будь-який момент).
                        </li>
                    </ul>
                </Section>
                ...
                <Section title="5. Треті сторони">
                    ...
                    <ul className="list-disc space-y-1.5 pl-6">
                        <li>
                            ...
                            — авторизація через Google OAuth (отримання email
                            та публічного імені на момент входу);
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            — доставка транзакційних email-листів (підтвердження,
                            magic link, нагадування про видалення акаунту);
                        </li>
                        <li>
                            <strong className="text-foreground">
                                Cloudflare R2
                ...
                <Section title="6. Cookies">
                    <p>
                        Ми використовуємо лише технічно необхідні cookies:
                    </p>
                    <ul className="list-disc space-y-1.5 pl-6">
                        <li>
                    ...
                    <p>
                        Аналітичних і трекінгових cookies не використовуємо.
                    </p>
                </Section>
                ...
                <Section title="7. Зберігання та видалення">
                    ...
                    <ul className="list-disc space-y-1.5 pl-6">
                        <li>
                            ...
                            доступ блокується, дані позначаються як
                            видалені, акаунт можна відновити протягом
                            grace-періоду;
                        </li>
                        <li>
                            <strong className="text-foreground">
                            ...
                            фоновий процес остаточно видаляє дані з нашої
                            БД після завершення grace-періоду.
                        </li>
                    </ul>
                    <p>
                        Дані, які ми зобовʼязані зберігати за вимогами
                        законодавства (наприклад, фіскальні платіжні
                        документи Stripe), зберігаються протягом строків,
                        встановлених відповідними нормативними актами.
                    </p>
                </Section>
                ...
                <Section title="8. Ваші права">
                    ...
                    <ul className="list-disc space-y-1.5 pl-6">
                        ...
                        <li>
                            подання скарги до уповноваженого державного
                            органу (Верховна Рада України, Уповноважений з
                            прав людини).
                        </li>
                    </ul>
                    <p>
                ...
                <Section title="9. Зміни до Політики">
                    <p>
                        ...
                        вході в сервіс — без цього подальша робота не
                        можлива. Дата чинної редакції вказана у верхній
                        частині сторінки.
                    </p>
                </Section>
