...
import { loadGuideSlugsSafe, loadGuideView } from '@/features/guides';
import { OG_COLORS } from '@/shared/styles/ogColors';

export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';
export const alt = 'Гайди Finly';

/** Pre-render one banner per published guide at build time. */
export async function generateStaticParams() {
    // Safe: API is unreachable during build; unknown slugs render on-demand.
...
export default async function Image({
    ...
    // true), same as the page route.
    if (!view) notFound();
    const title = view.guide.title;
