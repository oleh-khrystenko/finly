...
const FEATURES = [
    {
        Icon: Shield,
        title: 'Стандарт НБУ',
        body: 'Постанова №97, формат 003 — чинна з 1 листопада 2025 року. Не наш формат. Той самий, що читає будь-який банк-додаток в Україні.',
    },
    {
        Icon: Wallet,
    ...
    },
    {
        ...
        body: 'Privat, monobank, ПУМБ, Ощад, Sense, Укргазбанк, IZIBank, Райф, A-Bank, Кредит Дніпро. Паралельно — старий формат 002.',
    },
    {
        Icon: Sparkles,
        title: 'Безкоштовно для одного бізнесу',
        body: 'Один IBAN, безліч одноразових рахунків. Платні тарифи — для кількох бізнесів і власного лого на QR.',
    },
] as const;
