...
// Кути зеленого екрана у частках сторін фото (1448×1086). Виміряно піксель-
// перфект: до 4 країв зеленої зони підігнано прямі (least-squares, без зон
// скруглень) і перетнуто — це справжні кути екрана з урахуванням нахилу.
// Порядок: TL, TR, BL, BR.
const SCREEN_CORNERS = [
    [0.37467, 0.09135], // top-left
    [0.59966, 0.07097], // top-right
    [0.34592, 0.81915], // bottom-left
    [0.57028, 0.85082], // bottom-right
] as const;
