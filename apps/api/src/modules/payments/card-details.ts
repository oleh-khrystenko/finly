 ...
 * продовження. Перезапис звідти стер би те, чим картку прив'язували, і підпис
 * картки після першого ж продовження втратив би «Apple Pay» — єдине, по чому
 * платник цю картку впізнає, бо цифр у гаманця немає. Спосіб осідає на профілі
 * лише з інтерактивної оплати — тієї, де платник справді обирав, чим платити.
 */
