...
export class LandingClaimService {
    ...
    async attemptLandingClaim(
        ...
        // Sprint 27 — ліміти кількості бізнесів зняті; create приймає лише
        // ownership-режим (доменний інваріант «фізособа/ФОП по 1» тримає сам
        // create). Рівень доступу тут більше не потрібен.
