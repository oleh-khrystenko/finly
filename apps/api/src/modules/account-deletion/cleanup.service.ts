...
export class CleanupService {
    ...
    /**
     * Sprint 31 — позначка «лист надіслано» не переживає термін дії посилання.
    ...
    /**
     * Sprint 31 — добиває ефекти підтвердження на вже деактивованих акаунтах.
    ...
    /**
     * Sprint 31 — дзеркальний прохід: знімає позначки, що пережили відновлення
    ...
    private async hardDeleteExpiredAccounts(): Promise<void> {
        ...
        for (const user of expiredUsers) {
            ...
            try {
                ...
                // Sprint 31 — прибирання всього, що лишається після людини:
    ...
    /**
     * Sprint 31 — замок між прибиранням і відновленням акаунта. Список
