...
export const BRAND_LOGO = {
    ...
    /**
     * Верхня межа аспекту (width / height). Приймаємо квадрат і горизонтальний
     * прямокутник (вертикальні відсікає окрема перевірка height > width), але
     * НЕ надто витягнутий: при width / height > цього ліміту логотип не лишає
     * місця для опційного підпису у вузькій верхній смузі НБУ-QR (`bakeBand`),
     * і текст вилазить за межі. 6 покриває типові wordmark-логотипи (~3:1),
     * блокуючи лише патологічно широкі.
     */
    MAX_ASPECT_RATIO: 6,
    /**
