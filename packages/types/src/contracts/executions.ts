...
// CREDIT-нарахування з білінгу. Spend-екшени (report/ai/deep/audit), їхні
// вартості та spend/history-схеми видалені разом з ендпоінтами — повернуться
// з документ-агентом як простий лічильник-квота, не як валюта з резерваціями.
