...
│   └── modules/         # auth, users, payments, ai, storage, businesses, qr, invoices
├── web/src/
│   ├── app/             # pages: root, auth, (protected), host-pay/[slug] (single-locale, uk only)
│   ├── features/        # auth, billing, profile, change-theme, business-edit, business-wizard
│   ├── widgets/         # header
│   └── shared/          # api, ui, config, lib, styles, icons
packages/
└── types/src/           # constants, enums, entities, contracts, validation, qr
```
