...
**Status:** заплановано (2026-07-29), не стартував.

## [31. Злиття записів отримувача](31-business-merge/planning-questions.md)
...
**Status:** ініційовано (2026-08-11) — заведені питання для архітектури, відповідей ще немає, плану ще немає.

## [32. Видалення акаунта: доля отримувачів](32-account-deletion-cascade/README.md)
...
**Status:** заплановано (2026-08-13), не стартував. Передумова епіку документів: правило «отримувача з непорожнім архівом не можна видалити через видалення акаунта» без цього спринту не має на що спиратись.
