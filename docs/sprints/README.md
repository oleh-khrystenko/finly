...
>
> **Перенумерація 2026-08-23.** Порядок спринтів епіку документів приведено до порядку виконання: видалення акаунта стало 31 (було 32), сховище документів отримало 32, слоти 33..36, 38, 39 заведені заглушками під решту епіку, злиття записів поїхало на 37 (було 31) — воно не має живого сценарію до появи запрошень і мусить уміти переносити документи, тож його місце після сховища і конвеєра. Номер спринту в коментарях коду оновлено разом з нумерацією.
>
...
**Status:** реалізовано (код у `develop`). Передумова епіку документів: правило «отримувача з непорожнім архівом не можна видалити через видалення акаунта» без цього спринту не має на що спиратись.


## [32. Сховище документів](32-documents-storage/planning-questions.md)

Другий спринт епіку документів і перший, що торкається самих файлів: сутності документ-папка і незмінний файл під отримувачем, окремий приватний бакет з юрисдикцією ЄС і доступ лише за короткоживучими підписаними посиланнями, масовий прийом сотень файлів за раз, конвертація і стискання, квота гігабайтів, кошик, відмова від прав на отримувача замість видалення і заборона видалення при непорожньому архіві. AI у спринт не входить: документ живе з ручними метаданими, конвеєр приходить наступним.

**Status:** планується (2026-08-23).

## [33. AI-конвеєр обробки документів](33-ai-pipeline/README.md)
...
## [34. Словник тегів](34-tag-vocabulary/README.md)
...
## [35. Пошук і кабінет документів](35-documents-cabinet/README.md)
...
## [36. Пошуковий двигун](36-search-engine/README.md)
...
## [37. Злиття записів отримувача](37-business-merge/planning-questions.md)
...
## [38. Запрошення власника у спільний отримувач](38-owner-invitations/README.md)
...
## [39. Юридика і довідка епіку документів](39-legal-and-help/README.md)
