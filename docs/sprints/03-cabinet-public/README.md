...
> **Статус (оновлено 2026-05-04):** функціональний end-to-end flow реалізований (§3.0–§3.8 повністю; §3.9 host-aware routing + Server Component; §3.10 docs).
> **Open deliverable:** 11 SVG логотипів банків у `apps/web/src/shared/icons/banks/` (B5 — реальні; зараз generic text-tile як working fallback, не Sprint-plan-compliant).
...
> **Sprint вважається закритим після:** (а) збір 11 SVG, (б) UAT-прогон manual checks. Деталі — `docs/sprints/README.md` "Sprint 3 → Code deliverables / Open / Pending QA".
