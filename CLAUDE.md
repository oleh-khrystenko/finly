...
- `BILLING_DEMO_MODE` (на проді з живими грошима — `false`)
- Тарифна сітка (Sprint 27): `BILLING_BRAND_PRICE_PER_BUSINESS`, `BILLING_DOC_TIERS`, `BILLING_DOC_STORAGE_GB_PER_BUSINESS`, `BILLING_DOC_STORAGE_RENT_CREDITS_PER_GB`, `BILLING_DOC_CREDIT_PACKS`, `BILLING_DOC_LOW_BALANCE_THRESHOLD`, `BILLING_DOC_CRITICAL_BALANCE_THRESHOLD`, `BILLING_BRAND_ENABLED`, `BILLING_DOCUMENTS_ENABLED`
...
- `NEXT_PUBLIC_BILLING_DEMO_MODE` — демо-банер білінгу (у проді `false`)
